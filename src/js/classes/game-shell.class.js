...
export default class GameShell {
    ...
    buildLevelGUI() {
        ...
        let cleanCountInner = 
        '<div id="clean-stats"><div id="clean-count">'+ this.cleanCount +'</div><div class="text">Cleaned</div></div>'
